...
package sys_select_h is
  ...
  -- Get definition of timer specification structures.   
   subtype suseconds_t is bits_types_h.uu_suseconds_t;  -- /usr/include/sys/select.h:43
  ...
  --       from the global namespace.   
   ...
   type anon_array2864 is array (0 .. 15) of aliased uu_fd_mask;
   type fd_set is record
      uu_fds_bits : aliased anon_array2864;  -- /usr/include/sys/select.h:67
   end record
  ...
  --   __THROW.   
   ...
   function c_select
     (uu_nfds : int;
      ...
      uu_timeout : access bits_types_struct_timeval_h.timeval) return int  -- /usr/include/sys/select.h:102
   with Import => True, 
        Convention => C, 
  ...
  --   __THROW.   
   ...
   function pselect
     (uu_nfds : int;
      ...
      uu_sigmask : access constant bits_types_u_sigset_t_h.uu_sigset_t) return int  -- /usr/include/sys/select.h:127
   with Import => True, 
        Convention => C, 
